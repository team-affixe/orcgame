...
// Berserk alle 5 Sekunden spawnen lassen
...
function updateGame() {
  ...
  console.log(leftArrow, topArrow, rightArrow, bottomArrow);
...
//   if (berserkLeft < -100) {
//     // Wenn der Berserk aus dem Sichtbereich verschwindet
...
//   }
  ...
  if (berserkX == 6) {
    // 6 Frames für die Berserk-Animation
    berserkX = 0;
  }
}
